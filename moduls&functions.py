...
'''
    ...
    Метод это часть класса
'''

# donder
# Вызов написанной справки из функции
.__doc__
# напишем ф-ю сложения двух значений
def pus_two_values(v1, v2):
    # напишем справку
    '''
...
for i in range(5): # Переменная range генирирует посл-ть из 5 чисел, цикл for будет выполняться 5 раз
 ...
 # ______________________________sorted________________________________________
#  Сортировка в алфавитном порядке:


# Cортировка в словаре
for veriable in sorted(dict_name.keys()):
    print('{}:'.format(i))



# ______________________________ isinstance___________________________________
...
_______________________________________________________________________________
'''
# _________________________________Random______________________________________
